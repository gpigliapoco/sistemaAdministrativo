 ...
 * @author BeltariT
 */
public class vTabla_empleados extends javax.swing.JFrame {
...
//        SessionFactory factory = manager.getSessionFactory();
     ...
     empleadosManager funcOP=new empleadosManager(factory);
     
     public  String ventana="sueldos";
    
    public vTabla_empleados() {
        initComponents();
        mostrar();
    }
    ...
    public void mostrar(){
        ...
        List<dEmpleados> lista = funcOP.listadoOPbyNombre(txtBuscar.getText());
    ...
    private void tableOperadoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableOperadoresMouseClicked
       if (evt.getClickCount() == 1) {
          ...
          //  empleadosManager funcOP=new empleadosManager();
           // Long cod1=Long.valueOf(cod);
           // dts=funcOP.getOperadorById(cod1);
            
            
            if(ventana.equals("sueldos")){
            vSueldos.txtIdemple.setText(cod);
            vSueldos.txtNombre.setText(nombre);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vTabla_empleados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vTabla_empleados().setVisible(true);
            }
        });
    }
