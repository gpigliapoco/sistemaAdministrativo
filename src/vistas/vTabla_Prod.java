...
import Controllers.productosManager;
 ...
 * @author BeltariT
 */
public class vTabla_Prod extends javax.swing.JFrame {
...
//        };
        ...
        productosManager func=new productosManager(factory);
         DefaultTableModel model;

        List<dProductos> lista = func.getProductos();
    ...
    private void tableProductoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableProductoMouseClicked
       if (evt.getClickCount() == 1) {
            ...
            String cod = tableProducto.getValueAt(fila, 0).toString();
            String nombre=tableProducto.getValueAt(fila, 1).toString();
            
            
            if(ventana.equals("ventas")){
            vVentas.txtIdProducto.setText(cod);
            vVentas.txtProducto.setText(nombre);
            this.dispose();
            }
            if(ventana.equals("compra")){
            vCompras.txtIdproducto.setText(cod);
            vCompras.txtProducto.setText(nombre);
            this.dispose();
            }
            if(ventana.equals("produccion")){
            vProduccion.txtId.setText(cod);
            vProduccion.txtNombre.setText(nombre);
            this.dispose();
            }
             if(ventana.equals("report_ventas")){
            reportVTA1.txtIdpr.setText(cod);
            reportVTA1.txtProducto.setText(nombre);
            this.dispose();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vTabla_Prod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vTabla_Prod().setVisible(true);
            }
        });
    }
