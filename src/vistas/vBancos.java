 ...
 * @author BeltariT
 */
public class vBancos extends javax.swing.JInternalFrame {
...
//        SessionFactory factory = manager.getSessionFactory();
    ...
    public void mostar() {
       ...
       DefaultTableModel model;
        ...
        tableBancos.setModel(model);
        tableBancos.getColumnModel().getColumn(0).setMaxWidth(50);
    ...
    public void guardar(){
        ...
        dts.setNombre(txtBanco.getText());
        func.save(dts);
        mostar();
        txtBanco.setText("");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtBanco, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(10, 10, 10)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vBancos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
