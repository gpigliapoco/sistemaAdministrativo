 ...
 * @author BeltariT
 */
public class vTabla_Comprob extends javax.swing.JFrame {
...
//        SessionFactory factory = manager.getSessionFactory();
    ...
    public void mostrar(){
        ...
        for (dTipoComprobante lista1 : lista) {
            data[0] = lista1.getIdTipo_comprobante();
    ...
    private void tableComprobanteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableComprobanteMouseClicked
       if (evt.getClickCount() == 1) {
            ...
            vVentas.txtIdComprobante.setText(cod);
            vVentas.txtTipoComprobante.setText(nombre);
            vVentas.txtObservacion.setText(nombre);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vTabla_Comprob.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vTabla_Comprob().setVisible(true);
            }
        });
    }
