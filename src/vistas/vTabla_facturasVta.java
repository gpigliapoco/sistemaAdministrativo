 ...
 * @author BeltariT
 */
public class vTabla_facturasVta extends javax.swing.JFrame {
...
//        SessionFactory factory = manager.getSessionFactory();
    ...
    public vTabla_facturasVta() {
     ...
     public void mostrar(){
        ...
        List<dVentas> lista =func.getbyVTAxOPxFac(Long.valueOf(txtId.getText()),Long.valueOf(txtNumero.getText())); ///func.getbyVTAxOP(Long.valueOf(txtId.getText()));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BUSCADOR DE COMPROBANTES DE VENTA");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtRazon, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//        
    ...
    private void tableFacturaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableFacturaMouseClicked
        if (evt.getClickCount() == 1) {
            ...
            vEditorVentas.cod1=cod2;
           
            
            vEditorVentas.txtIdVta.setText(cod);
            vEditorVentas.txtFecha.setText(fecha);
            vEditorVentas.txtId.setText(txtId.getText());
            vEditorVentas.txtRazon.setText(txtRazon.getText());
            vEditorVentas.txtNumero.setText(rem);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vTabla_facturasVta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vTabla_facturasVta().setVisible(true);
            }
        });
    }
